...
| `feature-requests.md` | Requests filed from derived projects for what `a2bp` cannot carry (unmanaged files, missing capabilities). Identified by `FR-<project>-<slug>` codes, not item numbers; the owner assigns a number on promotion. |
