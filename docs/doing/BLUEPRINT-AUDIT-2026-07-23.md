...
- ~~**A-03**~~ — **FIXED (awaiting acceptance), pushed `b89e7a4`, four-eyes CLEAN on round 11.** The secret gate scanned
  ...
  Record: [`../waiting-acceptance/A-03-secret-gate/`](../waiting-acceptance/A-03-secret-gate/).
